...
getLines():-
        http_open("https://arqsi2020-grupo67.herokuapp.com/paths/complete", SPaths, []),
        http_open("https://arqsi2020-grupo67.herokuapp.com/pathnodes/complete", SPathNodes, []),
        http_open("https://arqsi2020-grupo67.herokuapp.com/nodes/complete", SNodes,[]),
...
aStar2(Dest,[(_,Chegada,[Dest|T])|Tail],Cam,Chegada):-
        reverse([Dest|T],Cam),!.
    
aStar2(Dest,[(_,HoraInicio,LA,HoraComeco)|Outros],Cam,HoraChegada):-
        LA=[Act|_],
